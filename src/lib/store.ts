...
const initial: AppState = {
  ...
  transactions: [
    { id: "t1", merchant: "مطعم البيك", category: "food", amount: -45, date: new Date().toISOString(), icon: "🍔" },
    { id: "t2", merchant: "محطة بنزين", category: "transport", amount: -80, date: new Date(Date.now() - 3600e3).toISOString(), icon: "⛽" },
    { id: "t3", merchant: "سوبر ماركت الدانوب", category: "groceries", amount: -120, date: new Date(Date.now() - 7200e3).toISOString(), icon: "🛒" },
    { id: "t4", merchant: "اشتراك Netflix", category: "subscriptions", amount: -55, date: new Date(Date.now() - 86400e3).toISOString(), icon: "🎬" },
    { id: "t5", merchant: "أمازون", category: "shopping", amount: -320, date: new Date(Date.now() - 2 * 86400e3).toISOString(), icon: "🛍️" },
    { id: "t6", merchant: "ستاربكس", category: "food", amount: -28, date: new Date(Date.now() - 3 * 86400e3).toISOString(), icon: "☕" },
    { id: "t7", merchant: "راتب شهري", category: "other", amount: 12000, date: new Date(Date.now() - 12 * 86400e3).toISOString(), icon: "💰" },
  ],
  goals: [
